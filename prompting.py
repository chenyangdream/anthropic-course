...
dataset = evaluator.generate_dataset(
    ...
    task_description="write a compact, consice 1 day meal plan for a single athlete",
    # Describe the different inputs that your prompt requires
    prompt_inputs_spec={
        "height": "Athlete's height in cm",
        "weight": "Athlete's weight in kg",
        "goal": "Athlete's goal (e.g. weight loss, muscle gain, maintenance)",
        "restrictions": "Athlete's dietary restrictions (e.g. vegetarian, gluten-free, etc.)",
    },
